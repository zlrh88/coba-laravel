        ...
        <div class="card-body text-center">
            <h2 class="card-title">
                ...
                <p> 
                     <small>
                        by : 
                        <a href="/posts?author={{ $posts[0]->author->username }}" class="text-decorations">{{ $posts[0]->author->name }} </a> 
                        in 
            ...
            <div class="col-md-4 mb-3">
                <div class="card h-100">
                    <div class="position-absolute px-3 py-2" style="background-color: rgba(0,0,0,0.7)">
                        <a class="text-white text-decoration-none" href="/posts?categories={{ $post->category->slug}}"> {{ $post->category->name }} </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-2">
                           <small>
                             by : 
                            <a href="/posts?author={{ $post->author->username }}" class="text-decorations">{{ $post->author->name }} </a> 
                            in 
